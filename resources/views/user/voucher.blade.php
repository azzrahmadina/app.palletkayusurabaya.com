        ...
        <div class="container">
          ...
          <div class="row gy-4 mb-5">
            <div class="row d-flex justify-content-center text-center">
                <div class="col-lg-6">
                    <form action="{{route('voucher.store')}}" method="POST" class="d-inline">
                        @csrf
          ...
          <div class="row">
            @if(session('data') && count(session('data')) > 0)
                @foreach(session('data') as $voucher)
                            ...
                            <div class="row g-0">
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Harga: <strong>Rp{{ number_format($voucher['price'], 0, ',', '.') }}</strong></p>
                                        <p class="card-text">Status: <strong>{{ $voucher['status'] }}</strong></p>
                                        <form action="{{route('voucher.transaction')}}" method="POST">
                                          @csrf
                                          <input type="hidden" name="kode_produk" value="{{ $voucher['code'] }}">
