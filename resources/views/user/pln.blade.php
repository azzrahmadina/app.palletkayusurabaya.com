      ...
      <div class="container">
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4 justify-content-center" data-aos="fade-in">
            <h1><span>PLN Pascabayar</span></h1>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          ...
          <div class="row gy-4 mb-5">
            <div class="row d-flex justify-content-center text-center">
                <div class="col-lg-6">
                    <form action="{{route('pln.store')}}" method="POST" class="d-inline">
                        @csrf
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="row g-0">
                                <div class="col-md-12">
                                    <div class="card-body">
                                        <h5 class="card-title">Nama : {{ $pln['nama_customer'] }}</h5>
                                        <p class="card-title">No : {{ $pln['no_customer'] }}</p>
                                        <p class="card-text">Harga : {{ number_format($pln['harga'], 0, ',', '.') }}</p>
                                        <p class="card-text">Biaya admin : {{ number_format($pln['biaya_admin'], 0, ',', '.') }}</p>
                                        <p class="card-text">Total harga : <strong>{{ number_format($pln['total'], 0, ',', '.') }}</strong></p>
                                        <form action="{{route('pln.transaction')}}" method="POST">
                                          @csrf
