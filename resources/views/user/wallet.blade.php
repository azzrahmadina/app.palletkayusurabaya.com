        ...
        <div class="container">
          ...
          <div class="row gy-4 mb-5">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-6">
                    <form action="{{route('e-wallet.store')}}" method="POST" class="d-inline">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="code_id"><h3>Pilih E-Wallet</h3></label>
          ...
          <div class="row">
            @if(session('data') && count(session('data')) > 0)
                @foreach(session('data') as $wallet)
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="row g-0">
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $wallet['nama_produk'] }}</h5>
                                        <p class="card-text">Harga: <strong>Rp{{ number_format($wallet['harga'], 0, ',', '.') }}</strong></p>
                                        <form action="{{route('wallet.transaction')}}" method="POST">
                                          @csrf
                                          <input type="hidden" name="code" value="{{ $wallet['kode_produk'] }}">
