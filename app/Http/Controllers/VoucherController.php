...
class VoucherController extends Controller
{
    public function index()
    {
        ...
        try {
            ...
            if (isset($data['status']) && $data['status'] === 'sukses') {
                return view('user.voucher', compact('data'));
            }
    ...
    public function Store(Request $request)
    {
        ...
        try {
            ...
            $response = $client->post('https://bospulsa.wahyurosamhidayat.xyz/api/aktivasi_voucher', [
                'form_params' => [
                    'nomor' => $request->phone,
                    'token' => $token,
                ],
            ...
            if (isset($data['status']) && $data['status'] === 'sukses') {
                ...
                return redirect()->back()->with('success', 'Paket data ditemukan.')->with('data', $data['aktivasi_voucher']);
            }
    ...
    public function transaction(Request $request)
    {
        ...
        try {
            ...
            $response = $client->post('https://bospulsa.wahyurosamhidayat.xyz/api/aktivasi_voucher/data', [
                'form_params' => [
