      ...
      <div class="container">
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4 justify-content-center" data-aos="fade-in">
            <h1><span>BPJS Kesehatan</span></h1>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          ...
          <div class="row gy-4 mb-5">
            <div class="row d-flex justify-content-center text-center">
                <div class="col-lg-6">
                    <form action="{{route('bpjs.store')}}" method="POST" class="d-inline">
                        @csrf
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="row g-0">
                                <div class="col-md-12">
                                    <div class="card-body">
                                        <h6 class="card-title">Nama : <strong>{{ $bpjs['nama_customer'] }}</strong></h6>
                                        <p class="card-title">No : {{ $bpjs['no_customer'] }}</p>
                                        <p class="card-text">Harga : {{ number_format($bpjs['harga'], 0, ',', '.') }}</p>
                                        <p class="card-text">Biaya admin : {{ number_format($bpjs['biaya_admin'], 0, ',', '.') }}</p>
                                        <p class="card-text">Total harga : <strong>{{ number_format($bpjs['total'], 0, ',', '.') }}</strong></p>
                                        <form action="{{route('bpjs.transaction')}}" method="POST">
                                          @csrf
